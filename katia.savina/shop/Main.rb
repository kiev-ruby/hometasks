...
def randomize
  ...
  name = ""
  7.times { name << chars[rand(chars.size)] }
  rand_shop = Shop.new(name)
  
  10.times do 
    item_name = ""
    category = ""
    7.times { item_name << chars[rand(chars.size)] }
    7.times { category << chars[rand(chars.size)] }
